...
class GraphMemory:
    ...
    async def initialize(self) -> None:
        ...
        await self._db.execute("CREATE INDEX IF NOT EXISTS idx_graph_rel_subj ON graph_relations(subject);")
        await self._db.execute("CREATE INDEX IF NOT EXISTS idx_graph_rel_obj ON graph_relations(object);")
    ...
    async def add_relation(
        ...
        # Track entities in graph_entities
        await self._db.execute(
            "INSERT OR IGNORE INTO graph_entities (name, type) VALUES (?, ?)",
            (sub, "entity"),
        )
        await self._db.execute(
            "INSERT OR IGNORE INTO graph_entities (name, type) VALUES (?, ?)",
