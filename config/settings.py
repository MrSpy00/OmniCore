...
def get_settings() -> Settings:
    """Return application settings singleton with thread-safe caching."""
    with _settings_lock:
        return _get_settings_cached()


def invalidate_settings_cache() -> None:
    """Clear cached settings safely across threads."""
    with _settings_lock:
        _get_settings_cached.cache_clear()


# Backward compatibility for direct .cache_clear calls on get_settings
